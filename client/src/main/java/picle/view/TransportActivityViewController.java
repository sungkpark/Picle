...
public class TransportActivityViewController {
    ...
    private Label score;
    @FXML
    private JFXToggleButton selectBikeRide;
    @FXML
    private JFXToggleButton selectPublicTransport;
    @FXML
    private Pane root;
    @FXML
    ...
    public void showInputDialog() {
        if (selectBikeRide.isSelected() || selectPublicTransport.isSelected()) {
            ...
            if (selectBikeRide.isSelected()) {
                labelParam1.setText("Distance on bike (km):");
                boxParam0.setVisible(false);
            } else if (selectPublicTransport.isSelected()) {
                labelParam1.setText("Distanced travelled (km):");
                boxParam0.setVisible(false);
            }
     ...
     * @param param0 User inputted distance
     */
    public void passParams(int param0) {
        if (selectBikeRide.isSelected()) {
            ...
            try {
                ...
                User user = new User(name, pass);
                ActivityController controller = new ActivityController(user);
                Activity activity = new Activity(-1, 4, param0, -1, -1);
                controller.addActivity(activity);
                Main.activateScreen("home.fxml");
